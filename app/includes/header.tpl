...
<head>
<meta charset="utf-8">
<title>fxnowwallet.com</title>
<link rel="canonical" href="https://www.fxnowwallet.com" />
<meta name="description" content="fxnowwallet.com is a free, open-source, client-side interface for generating FxNow wallets &amp; more. Interact with FxNow blockchain.">
...
-->
<meta name="apple-mobile-web-app-title" content="FxNowWallet">
<meta name="application-name" content="FxNowWallet">
<meta name="msapplication-config" content="images/fav/browserconfig.xml">
<meta name="theme-color" content="#1d6986">

<!--
<meta property="og:url" content="https://www.fxnowwallet.com" />
<meta property="og:title" content="FxNowWallet.com" />
<meta property="og:image" content="/images/fxnow-logo-banner.png" />
<meta property="og:image" content="/images/fxnow-logo.png" />
-->
<meta property="og:image" content="/images/fxnow-logo-square.png" />
<!--<meta property="og:image" content="/images/fxnow-banner-fun.jpg" />-->
<meta property="og:description" content="fxnowwallet.com is a free, open-source, client-side interface for generating Ethereum wallets &amp; more. Interact with the FxNow blockchain easily &amp; securely. Double-check the URL ( .com ) before unlocking your wallet." />
...
<header class="{{curNode.name}} {{curNode.service}} {{curNode.service}} nav-index-{{gService.currentTab}}" aria-label="header" ng-controller='tabsCtrl' >
  ...
  @@if (site === 'mew' ) {
    <div class="small announcement annoucement-danger">
      <div class="container">Always check the URL and look for FXNOWWALLET LLC [US] Certificate up there. Look for https://www.fxnowwallet.com/. <!--<a href="https://fxnowwallet.groovehq.com/knowledge_base/topics/protecting-yourself-and-your-funds" target="_blank" rel="noopener">Be safe &amp; secure</a>-->.</div>
    </div>
  }
    ...
    <section class="container">
      @@if (site === 'mew' ) {
        <a class="brand" href="/" aria-label="Go to homepage">
          <img src="images/logo-fxnowwallet.svg"   height="64px" width="245px" alt="MyEtherWallet" />
        </a>
      }
      @@if (site === 'cx'  ) {
