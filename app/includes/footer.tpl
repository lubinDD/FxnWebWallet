<section class="pre-footer">
  <div class="container">
    <p>fxnowwallet.com does not hold your keys for you. We cannot access accounts, recover keys, reset passwords, nor reverse transactions. Protect your keys &amp; always check that you are on correct URL. <!--<a role="link" tabindex="0" data-toggle="modal" data-target="#disclaimerModal"> You are responsible for your security.</a>-->
    </p>
  </div>
</section>
...
<footer class="footer" role="content" aria-label="footer" ng-controller='footerCtrl' >
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--left">
      ...
      <a href="/"><img src="images/logo-fxnowwallet.svg" height="45px" width="auto" class="footer--logo"/></a>

      <p><span translate="FOOTER_1">Free, open-source, client-side interface for generating FxNow wallets &amp; more. Interact with the FxNow blockchain easily &amp; securely. Double-check the URL ( .com ) before unlocking your wallet.</span></p>
    ...
    <section class="footer--cent">
        ...
        <p>ETH: <span class="mono wrap">mewtopia.eth <small>0x4cA5724A97e46e94205C07890344c1aD31E44521</small></span></p>
        <p>BTC: <span class="mono wrap">1MEWT2SGbqtP6m2439cnea85m2VZ54cW3</span></p>
        <!--
    ...
    -->
      ...
      <p>Copyright &copy; 2017 FxNow Wallet, LLC </p>
