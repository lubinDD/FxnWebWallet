...
nodes.nodeList = {
    ...
    'FxNow': {
        'name': 'FNC',
        'blockExplorerTX': 'http://54.36.19.185:3005/explorer/tx/[[txHash]]',
        'blockExplorerAddr': 'http://54.36.19.185:3005/explorer/account/[[address]]',
        'type': nodes.nodeTypes.FNC,
        'eip155': false,
        'chainId': 1,   //9000
        'tokenList': require('./tokens/fncTokens.json'),
        'abiList': require('./abiDefinitions/fncAbi.json'),
        'service': 'FxNowWallet',
        'lib': new nodes.customNode('http://54.36.19.185:9000', '')
    }
};
